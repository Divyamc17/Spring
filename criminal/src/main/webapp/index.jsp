...
label {
	...
	<form action="criminal" method="post" enctype="multipart/form-data">
		<div>
			...
			Name:<span clas="required" Style="color:red;">*</span>
			<input type="text" name="name" required minlength="3"
				maxlength="25" size="10">
             
		</div>
		<br>

		<div>
			Crime:<span clas="required" Style="color:red;">*</span>
			<select class="form-select" name="crime" required>
		...
		<br>
		<div>
			Alias Name:<span clas="required" Style="color:red;">*</span>
			<input type="text" name="aliasName" required minlength="3"
				maxlength="20" size="10">
		</div>
		<br>

		<div>
			Total Years Awarded:<span clas="required" Style="color:red;">*</span>
			<input type="number" name="awarded" required>
		</div>
		<div>
			<br> Description:<span clas="required" Style="color:red;">*</span>
		...
		<div>
			Jail Name:<span clas="required" Style="color:red;">*</span>
			<input type="text" name="jailName" required minlength="3"
				maxlength="20" size="10">
		</div>
		<br>
         <div>
			 Image:<span clas="required" Style="color:red;">*</span>
